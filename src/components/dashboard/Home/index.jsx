...
function LinkButton() {
  return (
    <div
      className="bg-secondary/25 p-2.5 md:p-5 fixed bottom-5 right-5 lg:right-20 rounded-full border-2 flex items-center justify-center"
      // data-aos="zoom-in"
      // data-aos-delay="700"
    >
      <a href="#" className="bg-primary p-2.5 md:p-5 rounded-full inline-block">
        <svg
          ...
          viewBox="0 0 32 32"
          fill="none"
          className="w-[15px] md:w-[32px] h-[15px] md:h-[30px]"
        >
          <path
